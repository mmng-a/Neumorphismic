...
internal enum ColorTransformer {
    ...
    static func rgbToHsl(
        ...
        let s: Double = {
            ...
            if cnt < 128 {
                ...
                return (maxVal - minVal) / (510 - maxVal - minVal)
            }
        }() * 255
    ...
    static func rgbToHsb(
        ...
        let s = (maxVal - minVal) / maxVal * 255
    ...
    private static func getHFromRGB(r: Double, g: Double, b: Double) -> Double {
        ...
        let h: Double
        switch maxVal {
        case r: h = cal(g - b, max: maxVal, min: minVal)
        case g: h = cal(b - r, max: maxVal, min: minVal) + 120
        case b: h = cal(r - g, max: maxVal, min: minVal) + 240
        default: h = 0
        }
        return h >= 0 ? h : h + 360
    }
